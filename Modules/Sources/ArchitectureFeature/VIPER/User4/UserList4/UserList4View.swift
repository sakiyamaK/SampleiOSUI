...
public protocol UserList4View: UIView {
    func setup(presenter: UserList4Presenter)
}

public final class UserList4ViewImpl: UIView, UserList4View {
    ...
    private var presenter: UserList4Presenter!
    ...
    public func setup(presenter: UserList4Presenter) {
...
extension UserList4ViewImpl: UICollectionViewDelegate {
...
#Preview {
    MainActor.assumeIsolated {
        UserList4RouterImpl.assembleModules(isDummy: true)
    }
}
