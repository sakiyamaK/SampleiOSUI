...
public protocol UserList2View: UIView {
    func setup(presenter: UserList2Presenter)
}

public final class UserList2ViewImpl: UIView, UserList2View {
    ...
    private var presenter: UserList2Presenter!
    ...
    public func setup(presenter: UserList2Presenter) {
...
extension UserList2ViewImpl: UICollectionViewDelegate {
...
#Preview {
    MainActor.assumeIsolated {
        UserList2RouterImpl.assembleModules(isDummy: true)
    }
}
