...
public protocol UserList2Interactor {
...
@Observable
public final class UserList2InteractorImpl: UserList2Interactor {
    ...
    public func fetch() async {
        ...
        do {
            ...
            users = try await API.shared.getUsers(isDummy: isDummy)
        } catch let e {
            users = []
            DLog(e)
        }
