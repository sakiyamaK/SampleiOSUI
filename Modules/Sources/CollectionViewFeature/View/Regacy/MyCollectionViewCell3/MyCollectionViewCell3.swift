...
final class MyCollectionViewCell3: UICollectionViewCell {
    private static var mockCell: MyCollectionViewCell3 = MyCollectionViewCell3.makeFormNibFirst(bundle: .module)!
...
#Preview {
    UIViewController()
        .declarative {
            MyCollectionViewCell3.makeFormNibFirst(bundle: .module)!
