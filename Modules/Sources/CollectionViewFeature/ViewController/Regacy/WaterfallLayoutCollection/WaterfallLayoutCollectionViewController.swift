...
extension WaterfallLayoutCollectionViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        (collectionView.dequeueReusableCell(withReuseIdentifier: MyCollectionViewCell2.className, for: indexPath) as! MyCollectionViewCell2).configure(sampleModel: samples[indexPath.item])
    }
}

#Preview {
    WaterfallLayoutCollectionViewController.makeFromStroryboard(name: "WaterfallLayoutCollection", bundle: .module)!
}
