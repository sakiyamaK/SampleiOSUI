...
@objc private extension SampleViewController {
    func setupLayout() {
        ...
        self.applyView({
            ...
            UIImageView()
                ...
                .apply {
                    $0.kf.setImage(with: URL(string: "https://picsum.photos/200/300"))
                }
        }.declarative {
            UIStackView.vertical {
                ...
                UIStackView.horizontal {
                    ...
                    UIImageView(UIImage(systemName: "questionmark.circle")?
                ...
                UIStackView.horizontal {
                    ...
                    UIStackView.vertical {
                        UIView()
                            ...
                            .zStack {
                                UIImageView(UIImage(systemName: "plus")?
                                    .withTintColor(.white, renderingMode: .alwaysOriginal))
                                    .contentMode(.scaleAspectFit)
